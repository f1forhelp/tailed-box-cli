...
func TestPingOverQUIC(t *testing.T) {
...
func TestPingRejectsUnknownServer(t *testing.T) {
	fixture := newFixture(t)
...
func TestPingRejectsUnknownClient(t *testing.T) {
	fixture := newFixture(t)
	fixture.trustMasterOnWorker(t)
	listener := fixture.listenMaster(t)
	defer listener.Close()
	...
	_, err := Ping(ctx, fixture.workerPaths, listener.Addr().String())
	if err == nil {
		t.Fatal("Ping succeeded without master trusting worker")
	}
}

func TestPingRejectsRevokedClient(t *testing.T) {
	fixture := newFixture(t)
	fixture.trustBoth(t)
